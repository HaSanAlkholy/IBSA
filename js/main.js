$(window).on("load", function () {
  ...
  //slider transition
  {
    ...
    document.getElementById('slider-btn-next').addEventListener('click', addTrans)
    document.getElementById('slider-btn-prev').addEventListener('click', removeTrans)
    
    function addTrans(){
      if(!flag){
        document.getElementById('services-content').classList.add('slideActive');
        flag = !flag
      }
    }
    ...
    function removeTrans(){
      if(flag){
        document.getElementById('services-content').classList.remove('slideActive');
        flag = !flag
      }
    }
  }
